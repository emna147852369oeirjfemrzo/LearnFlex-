...
#[Route('/evenements/recherche', name: 'evenement_search')]
    public function search(Request $request, EvenementRepository $evenementRepository): Response
    {
        ...
        $evenements = $evenementRepository->searchEvenements(['titre' => $query]);
    ...
    #[Route('/evenements/tri-heure', name: 'evenement_sort')]
    public function sortByHeure(Request $request, EvenementRepository $evenementRepository): Response
    {
        ...
        return $this->render('evenement/index.html.twig', [
            'evenements' => $evenements,
            'current_sort' => 'heuredebut',
            'current_direction' => $direction,
        ]);
    }
    #[Route('/front/evenements', name: 'front_evenements')]
    public function eventfront(EvenementRepository $evenementRepository): Response
    {
        ...
        // Afficher les événements dans le front-office
        return $this->render('front/afficher.html.twig', [
            'evenements' => $evenements,
        ]);
    }

    #[Route('/front/evenement/{id}', name: 'front_evenement_show')]
    public function showfront(int $id, EvenementRepository $evenementRepository): Response
    {
    ...
    #[Route('/{id}/inscription', name: 'evenement_inscription')]
    public function inscription(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $this->addFlash('success', 'Inscription envoyée avec succès');
